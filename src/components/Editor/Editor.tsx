...
function App({ initialContent, readOnly = false }: AppProps) {
  const [content, setContent] = useState(initialContent || DEFAULT)

  // Detect app's dark/light mode (from html element class)
  ...
  const editor = useEditor({
    ...
    content,
    extensions,
    editable: !readOnly, // Make read-only if prop is true
